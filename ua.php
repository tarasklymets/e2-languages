...
function e2l_load_strings () {
  ...
  'e2--vname-aegea' => 'Егея',
  'e2--release' => 'реліз',
  'e2--powered-by' => 'Двигунець —',
  'e2--default-blog-title' => 'Мій блог',
  'e2--default-blog-author' => 'Автор блогу',
  
  // installer
  'pt--install' => 'Встановлення Егеї',
  'gs--user-fixes-needed' => 'Так, потрібно дещо підправити.',
  'gs--following-folders-missing' => 'Не знайдено наступні директорії із дистрибутива двигунця:',
  'gs--could-not-create-them-automatically' => 'Створити їх автоматично не вдалося через брак прав. Завантажте на сервер повний дистрибутив.',
  'gs--and-reload-installer' => 'І перезавантажте інсталятор',
  ...
  'gs--instantiated-version' => 'Інстанціірована версія',
  'pt--installer-loading' => 'Завантаження...',
  'gs--database' => 'База данних',
  'gs--password-for-blog' => 'Пароль, який хочете використовувати для доступу до блогу',
  'gs--data-exists' => 'У цій базі вже є блог. Інсталятор просто підключиться до неї.',
  'er--db-data-incomplete' => 'У цій базі вже є частина даних блогу, але вони неповні. Можливо, з нею використовувалася інша версія Егеї. Встановіть Егею тієї версії, від якої дані в базі, а потім поновіть, якщо потрібно. Для чистої установки надайте чисту базу.',
  // diags
  ...
  // sign in
  'pt--sign-in' => 'Вхід',
  'er--cannot-write-auth-data' => 'Не вдалося записати данні аутентифікації',
  // archive
  'pt--nth-year' => '$[year]-й рік',
  'pt--nth-month-of-nth-year' => '$[month.monthname] $[year] року',
  'pt--nth-day-of-nth-month-of-nth-year' => '$[day] $[month.monthname.genitive] $[year]-ку',
  'gs--nth-month-of-nth-year' => '$[month.monthname] $[year]',
  'gs--nth-day-of-nth-month-of-nth-year' => '$[day] $[month.monthname.genitive] $[year]',
  'gs--everything' => 'Все',
  'gs--part-x-of-y' => 'частина $[part] із $[of]',
  
  // posts
  'ln--new-post' => 'Нова',
  'bt--close-comments-to-post' => 'Закрити комментарі до замітки',
  'bt--open-comments-to-post' => 'відкрити комментарі до замітки',
  'pt--new-post' => 'Нова замітка',
  'pt--edit-post' => 'Редагування замітки',
  'er--post-must-have-title-and-text' => 'У замітки повинні бути назва та текс',
  'er--error-updating-post' => 'Помилки при редагуванні замітки',
  'er--error-deleting-post-tag-info' => 'Помилка при видаленні данних про теги заміток',
